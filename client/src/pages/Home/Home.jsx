  ...
  return (
    <div className={styles.home}>
      <div className={styles.showCase}>
        ...
        <Carousel swipeable autoplay infiniteloop autoFocus showStatus={false} showThumbs={false} transitionTime={700} showIndicators={false} >
          <div className={styles.slider}>
            ...
            <motion.h2
              initial={{ x: -200 }} animate={{ fontSize: 50, color: 'white', x: 0, y: 0 }} exit={{ opacity: 0.5 }} initial={{ x: -200 }} animate={{ fontSize: 50, color: 'white', x: 0, y: 0 }} exit={{ opacity: 0.5 }}
            >NEVER STOP EXPLORING THE UNIVERSE</motion.h2>
